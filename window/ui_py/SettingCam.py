...
class Ui_SettingCam(object):
    def setupUi(self, SettingCam):
        ...
        self.cam_photo = QVideoWidget(self.groupBox)
        ...
        self.cam_pasport = QVideoWidget(self.groupBox_2)
    ...
    def retranslateUi(self, SettingCam):
        SettingCam.setWindowTitle(QCoreApplication.translate(
            "SettingCam", u"\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u043a\u0430\u043c\u0435\u0440\u044b", None))
        self.groupBox.setTitle(QCoreApplication.translate(
            "SettingCam", u"\u0424\u043e\u0442\u043e \u043b\u0438\u0446\u0430", None))
        self.chacked_cam_face.setText(QCoreApplication.translate(
            "SettingCam", u"\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c", None))
        self.stop_cam_face.setText(QCoreApplication.translate(
            "SettingCam", u"\u041e\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c", None))
        self.groupBox_2.setTitle(QCoreApplication.translate(
            "SettingCam", u"\u0424\u043e\u0442\u043e \u043f\u0430\u0441\u043f\u043e\u0440\u0442\u0430", None))
        self.checked_cam_pasport.setText(QCoreApplication.translate(
            "SettingCam", u"\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c", None))
        self.stop_cam_pasport.setText(QCoreApplication.translate(
            "SettingCam", u"\u041e\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c", None))
        self.save_setting_cam.setText(QCoreApplication.translate(
            "SettingCam", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438", None))
    # retranslateUi
