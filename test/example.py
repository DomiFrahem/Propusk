...
if __name__ == '__main__':
    ...
    #   pallette = self.imagePhoto.palette()
    #     pixmap = QPixmap(QImage("image/no_media_main.jpg"))
    #     pixmap.scaled(402, 314)
    #     pallette.setBrush(QPalette.Window, QBrush(pixmap))
    #     self.imagePhoto.setAutoFillBackground(True)
    #     self.imagePhoto.setPalette(pallette)